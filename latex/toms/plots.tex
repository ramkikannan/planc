...
\begin{axis}[\relerrplotoptions]
	\addplot+ [discard if not={algo}{MU},discard if not={runs}{\run},green,thick,mark options={solid}] table [x={totaltime}, y={relerr}] {\datafile};
	\addplot+ [discard if not={algo}{HALS},discard if not={runs}{\run},red,thick,mark options={solid},mark=square*] table [x={totaltime}, y={relerr}] {\datafile};
	\addplot+ [discard if not={algo}{BPP},discard if not={runs}{\run},blue,thick,mark options={solid},mark=triangle*] table [x={totaltime}, y={relerr}] {\datafile};
	\iflegend
		\legend{MU,HALS,ABPP}
	\fi
\end{axis}
