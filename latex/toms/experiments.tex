...
%\textcolor{red}{Finally, we ran on 512 nodes, utilizing the 16 threads per node via parallel BLAS and OMP, for a $1024\times1024\times1024$ synthetic tensor and processor grid $8\times8\times8$. Here we observe a $253\times$ speedup which is the result of each node having less than 20 megabytes of data.}
...
\renewcommand{\run}{32}
\renewcommand{\xmax}{4.9}
\renewcommand{\ymin}{0}
\renewcommand{\ymax}{.25}
\subfloat[Low rank $k=32$ \label{fig:accuracylr81k32}]{
\tikzsetnextfilename{accuracylr81k32}
\ylabeltrue
\widertrue
\legendfalse
\begin{tikzpicture}
\renewcommand{\datafile}{data/accuracylr81pksweep.csv}
\renewcommand{\run}{32}
\relerrplot
\end{tikzpicture}
\ylabelfalse
...
\tikzsetnextfilename{accuracylr81k64}
\widertrue
\legendfalse
\begin{tikzpicture}
\renewcommand{\datafile}{data/accuracylr81pksweep.csv}
...
\tikzsetnextfilename{accuracylr81k96}
\ylabeltrue
\widertrue
\legendtrue
\begin{tikzpicture}
...
\caption{Relative error comparison of \MU, \HALS, \BPP\, \ADMM, \Nestrov\ on 4D Synthetic Low Rank Tensor of size 162x162x162x162 on 3x3x3x3 Processor Grid.}
...
\begin{figure}
	...
	\renewcommand{\ymin}{0}
	\renewcommand{\ymax}{.25}
	\subfloat[Low rank $k=32$ \label{fig:accuracyrwk32}]{
		\tikzsetnextfilename{accuracyrwk32}
		\ylabeltrue
		\widertrue
		\legendfalse
		\begin{tikzpicture}
		\renewcommand{\datafile}{data/accuracyrwksweep.dat}
		\renewcommand{\run}{32}
		\relerrplot
		\end{tikzpicture}
		\ylabelfalse
	...
	\subfloat[Low rank $k=64$ \label{fig:accuracyrwk64}]{
		\tikzsetnextfilename{accuracyrwk64}
		\widertrue
		\legendfalse
		\begin{tikzpicture}
		\renewcommand{\datafile}{data/accuracyrwksweep.dat}
	...
	\subfloat[Low rank $k=96$ \label{fig:accuracyrwk96}]{
		\tikzsetnextfilename{accuracyrwk96}
		\ylabeltrue
		\widertrue
		\legendtrue
		\begin{tikzpicture}
	...
	\caption{Relative error comparison of \MU, \HALS, \BPP\, \ADMM, \Nestrov\ on 4D Realworld Low Rank Tensor of size $200 \times 500 \times 64 \times 192$ on $2\times4\times2\times4$ Processor Grid.}
...
%set which run to plot
\renewcommand{\run}{32}
\renewcommand{\xmax}{9.9}
\renewcommand{\ymin}{.4}
\renewcommand{\ymax}{.52}
\subfloat[Low rank $k=32$ \label{fig:accuracyuni81k32}]{
\tikzsetnextfilename{accuracyuni81k32}
\ylabeltrue
\widertrue
\legendfalse
\begin{tikzpicture}
\renewcommand{\datafile}{data/accuracyuni81pksweep.csv}
\renewcommand{\run}{32}
\relerrplot
\end{tikzpicture}
\ylabelfalse
}
\subfloat[Low rank $k=64$ \label{fig:accuracyuni81k64}]{
\tikzsetnextfilename{accuracyuni81k64}
\widertrue
\legendfalse
\begin{tikzpicture}
\renewcommand{\datafile}{data/accuracyuni81pksweep.csv}
...
\subfloat[Low rank $k=96$ \label{fig:accuracyuni81k96}]{
\tikzsetnextfilename{accuracyuni81k96}
\ylabeltrue
\widertrue
\legendtrue
\begin{tikzpicture}
...
\caption{Relative error comparison of \MU, \HALS, \BPP\, \ADMM, \Nestrov\ on 4D Synthetic Uniform Tensor of size 162x162x162x162 on 3x3x3x3 Processor Grid.}
\label{fig:convergenceuniform}
\end{figure}
...
\renewcommand{\numiterations}{29}
\renewcommand{\nogpu}{1}
\renewcommand{\xmax}{128}
\renewcommand{\ymax}{12}

\subfloat[CPU \label{fig:cpulr81}]{
\tikzsetnextfilename{cpulr81}
\ylabeltrue
\widertrue
\legendfalse
\begin{tikzpicture}
...
\caption{Timing comparison of \MU, \HALS, \BPP\, \ADMM, \Nestrov\ on 4D Synthetic Low Rank Tensor of size 162x162x162x162 on 3x3x3x3 Processor Grid on CPU.}
...
\renewcommand{\numiterations}{29}
\renewcommand{\nogpu}{0}
\renewcommand{\xmax}{125}
\renewcommand{\ymax}{12}

\subfloat[CPU \label{fig:cpuuni81}]{
\tikzsetnextfilename{cpuuni81}
\ylabeltrue
\widertrue
\legendfalse
\begin{tikzpicture}
...
\subfloat[GPU \label{fig:gpuuni81}]{
\tikzsetnextfilename{gpuuni81}
\widertrue
\legendtrue
\begin{tikzpicture}
\renewcommand{\datafile}{data/accuracyuni81pksweep.csv}
...
\caption{Timing comparison of \MU, \HALS, \BPP\, \ADMM, \Nestrov\ on 4D Synthetic Uniform Tensor of size 162x162x162x162 on 3x3x3x3 Processor Grid on CPU.}
\label{fig:cpuvsgpuuniform}
\end{figure}

\renewcommand{\numiterations}{29}
\renewcommand{\xmax}{125}
\renewcommand{\ymax}{.05}
\begin{figure}
\subfloat[Uniform \label{fig:lucuni81}]{
\tikzsetnextfilename{lucuni81}
\ylabeltrue
\widertrue
\legendfalse
\begin{tikzpicture}
\renewcommand{\datafile}{data/lucuni81pksweep.csv}
\lucplot
\end{tikzpicture}
\ylabelfalse
}
\subfloat[Low Rank \label{fig:luclr81}]{
\tikzsetnextfilename{luclr81}
\widertrue
\legendtrue
\begin{tikzpicture}
\renewcommand{\datafile}{data/luclr81pksweep.csv}
\renewcommand{\nogpu}{1}
\lucplot
\end{tikzpicture}
}
\caption{LUC comparison of \MU, \HALS, \BPP\, \ADMM, \Nestrov\ on 4D Synthetic Uniform and Low Rank Tensor of size 162x162x162x162 on 3x3x3x3 Processor Grid on CPU.}
\label{fig:luccomp}
\end{figure}