...
\caption{Relative error comparison of \MU, \HALS, \BPP\, \ADMM, \Nestrov on 4D Synthetic Uniform Tensor of size 129x129x129x129 on 3x3x3x3 Processor Grid.}
...
\caption{Timing comparison of \MU, \HALS, \BPP\, \ADMM, \Nestrov on 4D Synthetic Low Rank Tensor of size 129x129x129x129 on 3x3x3x3 Processor Grid on CPU.}
...
\caption{Timing comparison of \MU, \HALS, \BPP\, \ADMM, \Nestrov on 4D Synthetic Uniform Tensor of size 129x129x129x129 on 3x3x3x3 Processor Grid on CPU.}
...
\caption{LUC comparison of \MU, \HALS, \BPP\, \ADMM, \Nestrov on 4D Synthetic Uniform and Low Rank Tensor of size 129x129x129x129 on 3x3x3x3 Processor Grid on CPU.}
\label{fig:luccomp}
\end{figure}