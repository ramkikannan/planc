...
\paragraph{Checkerboard hypergraph partitioning~(\textbf{CH2})} We aim to partition the matrix $\Am$ into $P_r$ row slices first, and $P_c$ column slices next, to obtain an $P_r \times P_c$ checkerboard partition.
