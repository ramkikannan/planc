...
In particular, we consider two previous works developed for related problems, one that uses a fine-grained partitioning strategy using a point-to-point communication pattern and on that uses a coarse-grained partitioning strategy using a collective-based communication pattern.
