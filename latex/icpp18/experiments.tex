...
\newcommand{\krch1}{\textbf{CH1}\xspace}
\newcommand{\krch2}{\textbf{CH2}\xspace}
...
\caption{Communication and computation costs of different partitioning strategies on Kronecker graphs}
\label{fig:nnzsweep}
\end{figure}
