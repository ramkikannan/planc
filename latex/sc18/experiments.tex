...
The performance on the synthetic tensor is shown in \cref{fig:strongsynthetic3D}. 
...
In \cref{fig:strongsynthetic5D}, we benchmark performance for a 5D tensor, so we can no longer compare against NbAO-NTF.
