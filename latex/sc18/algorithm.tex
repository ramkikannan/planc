...
Thus, it is computationally cheaper than the partial MTTKRPs, but it is also typically bandwidth bound.
...
The computational cost of this operation is also typically lower order, but the running time in practice suffers from being bandwidth bound.
