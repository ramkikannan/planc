  ...
  private:
    ...
    */
    ...
    void build_local_tensor() {
        ...
        // Local_size = global_size/proc_grids // mode wise division. Local_size is a vector of size modes
        // For i over modes // at the end of this loop we will have the start_idx and end_idx of every  mode for every rank
