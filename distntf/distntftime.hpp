...
class DistNTFTime {
 ...
 public:
  ...
  DistNTFTime(double d, double compute_d, double communication_d,
              double trans_d, double allgather_d, double allreduce_d,
              double reducescatter_d, double gram_d, double krp_d,
              double mttkrp_d, double multittv_d, double nnls_d,
              double err_comp, double err_comm)
      : m_duration(d),
        m_compute_duration(compute_d),
        ...
        m_krp_duration(krp_d),
        m_mttkrp_duration(mttkrp_d),
